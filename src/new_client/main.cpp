...
{
  ServerMessages::MessageTypes msgType = ServerMessages::getType( buf[ 0 ] );
...
int so_login( unsigned char *buf )
{
  ...
  if ( buf[ 0 ] == ServerMessages::getValue( ServerMessages::MessageTypes::CHALLENGE ) )
  ...
  if ( buf[ 0 ] == ServerMessages::getValue( ServerMessages::MessageTypes::NEWPLAYER ) )
