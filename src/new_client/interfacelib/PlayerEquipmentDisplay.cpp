...
PlayerEquipmentDisplay::PlayerEquipmentDisplay( const PlayerData& playerData, const GraphicsCache& gfxCache )
...
void PlayerEquipmentDisplay::onUserInput( const sf::Event& )
{
}
