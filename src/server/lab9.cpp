...
struct destination
{
  int x;
  int y;
} destinations[ RIDDLEGIVERS ] = { { 39, 729 }, { 40, 749 }, { 40, 769 }, { 40, 789 }, { 34, 806 } };
...
struct switch_question
{
  ...
  char* question;
    ...
    { // bank 1
      ...
      { TRUE, "There is a purple flower growing under the tree beside the Magic Shop." } }, // end bank 1
    ...
    { // bank 2
      ...
      { FALSE, "Leopold is an old man of about 70 years." } }, // end bank 2
    ...
    { // bank 3
      ...
      { FALSE, "There is a green flower growing behind the Leather Armor Shop." } }, // end bank 3
    ...
    { // bank 4
      ...
      { TRUE, "Nasir's left eye looks as if it was made of glass." } }, // end bank 4
    ...
    { // bank 5
      ...
      { FALSE, "Cirrus is a fat old man." } } // end bank 5
};
...
struct bank
{
  ...
  int doorx;
  int doory;
} banks[ BANKS ] = { { 23, 707, 1047, 23, 720 },
                     { 23, 727, 1069, 23, 741 },
                     { 23, 747, 1076, 23, 761 },
                     { 23, 767, 1084, 31, 781 },
                     { 23, 787, 1088, 19, 803 } };
...
int lab9_guesser_says( int cn, char* text )
{
  ...
  while ( 1 )
  {
    ...
    if ( ! strcasecmp( word, riddle->answer1 ) || ( riddle->answer2 && ! strcasecmp( word, riddle->answer2 ) ) ||
...
int use_lab9_door( int cn, int in )
{
  ...
  else if ( ! it[ in ].active && ( ( ch[ cn ].x > it[ in ].x ) || ( ch[ cn ].y < it[ in ].y ) ) )
  {
