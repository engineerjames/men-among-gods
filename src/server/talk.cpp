...
char* fillword[] = { "the",  "a", "an",   "do",  "'",  "of", "is",    "that", "those", "these",
                     "they", "-", "does", "can", "oh", "me", "about", "to",   "if",    "for" };
...
char* syn[] = { "1",        "one",         "2",          "two",       "3",          "three",     "4",          "four",    "5",
                "five",     "6",           "six",        "7",         "seven",      "8",         "eight",      "9",       "nine",
                "whats",    "what",        "which",      "what",      "wheres",     "where",     "dangers",    "danger",  "enemies",
                "danger",   "enemy",       "danger",     "foe",       "danger",     "foes",      "danger",     "thieves", "thief",
                "trouble",  "danger",      "laby",       "labyrinth", "rubies",     "ruby",      "joes",       "joe",     "skeletons",
                "skeleton", "templars",    "templar",    "outlaws",   "outlaw",     "merchants", "merchant",   "hi",      "hello",
                "hail",     "hello",       "greetings",  "hello",     "goodbye",    "bye",       "whos",       "who",     "thanks",
                "thank",    "mission",     "quest",      "starting",  "start",      "damors",    "damor",      "jamils",  "jamil",
                "sirjans",  "sirjan",      "point",      "place",     "1st",        "first",     "2nd",        "second",  "3rd",
                "third",    "limitations", "limitation", "limits",    "limitation", "limit",     "limitation", "quit",    "exit",
                "leave",    "exit",        "ratlings",   "ratling",   "eyes",       "eye",       "helmet",     "helm",    "shadows",
                "shadow",   "poems",       "poem" };
...
#define RIDDLE_TEXT                                                                                                                        \
  "If you bring me the right volume of the Book of Wisdom, I will tell you a riddle. To answer the riddle, just say the word the riddle "  \
  "asks for. If you answer correctly, I will bring you to the next stage of your quest.\n"
...
struct know know[] = {
    ...
    { { "!where", "?haunted", "!castle", "?", NULL },
      0,
      AR_ASTON,
      0,
      "The Haunted Castle is in the south-east corner of the city, on Castle Way.",
      0 },
    { { "!where", "?cursed", "!tomb", "?", NULL },
      0,
      AR_ASTON,
      0,
      "The Cursed Tomb is in the north-east corner of the city, on Rose Street.",
      0 },
    { { "!where", "!joe", "?house", "?", NULL }, 0, AR_ASTON, 0, "Joe's House is in the middle of Castle Way.", 0 },
    { { "!where", "?skeleton", "!lord", "?", NULL },
      0,
      AR_ASTON,
      0,
      "The Skeleton Lord is in the dark, large building in the middle of Merchants Way.",
      0 },
    { { "!where", "?templar", "!outlaw", "?", NULL },
      0,
      AR_ASTON,
      0,
      "The Templar Outlaws live in a fortified building in the south-west corner of Aston.",
      0 },
    ...
    { { "!where", "!random", "?dungeon", "?", NULL },
      0,
      AR_ASTON,
      0,
      "The entrance to the Random Dungeon is in the middle of Merchants Way.",
      0 },
    ...
    { { "!have", "!no", "!money", "?", NULL },
      ...
      AR_ASTON,
      0,
      "You might find some valuable stuff in the Donations Room in one of the temples.",
      0 },
    { { "!where", "!temple", "!street", "?", NULL },
      0,
      AR_ASTON,
      0,
      "The Temple Street is in the northern part of the city. It goes from the east to the west end of Aston.",
      0 },
    ...
    { { "!where", "!merchant", "!way", "?", NULL },
      0,
      AR_ASTON,
      0,
      "The Merchants Way divides the city in the middle. It goes from north to south.",
      0 },
    ...
    { { "!who", "!damor", "?", NULL },
      ...
      AR_ASTON,
      0,
      "Damor came into Aston about 60 years ago. Noboby knows where he came from. He is very powerful, so no one dared to ask.",
      0 },
    { { "!tell", "!damor", "?", NULL },
      5,
      AR_ASTON,
    ...
    { { "?what", "?where", "?good", "!start", "?place", "?", NULL },
      0,
      AR_ASTON,
      0,
      "A good place to start your adventurer's life? You'd best talk to Jamil.",
      0 },
    { { "?tell", "?where", "?good", "!start", "?place", "?", NULL },
      0,
      AR_ASTON,
      0,
      "A good place to start your adventurer's life? You'd best talk to Jamil.",
    ...
    { { "!where", "?thief", "!house", "?", NULL }, 0, AR_THIEF, 25, "The Thieves House is located at the east end of Temple Street.", 0 },
    { { "!locked", "!door", "!thief", "?house", "?", NULL },
      25,
      AR_THIEF,
      25,
      "There are two locked doors in the Thieves House. For the first, you'll easily find the key.",
      0 },
    { { "!second", "!door", "!thief", "?house", "?", NULL },
      25,
      AR_THIEF,
      25,
      "The second locked door in the Thieves House? Don't go there!.",
      0 },
    { { "!danger", "!thief", "?house", "?", NULL },
      25,
      AR_THIEF,
      25,
      "What would you expect in the Thieves' House? Thieves of course. They're very poor fighters.",
      0 },
    { { "!tell", "!thief", "?house", "?", NULL },
      25,
      AR_THIEF,
      25,
      "What would you expect in the Thieves' House? Thieves of course. They're very poor fighters.",
      0 },
    { { "!who", "!thief", "?house", "?", NULL },
      25,
      AR_THIEF,
      25,
      "What would you expect in the Thieves' House? Thieves of course. They're very poor fighters.",
    ...
    { { "!where", "?haunted", "!castle", "?", NULL },
      ...
      "The Haunted Castle is in the south-east corner of the city, on Castle Way.",
      0 },
    { { "!locked", "!door", "?haunted", "?castle", "?", NULL },
      50,
      AR_CASTLE,
      28,
      "My guess is that you'll have to find the keys for the locked doors in the Haunted Castle, %s.",
      0 },
    { { "!key", "?haunted", "?castle", "?", NULL },
      50,
      AR_CASTLE,
      28,
      "Not all walls are what they seem to be in the Haunted Castle, %s.",
      0 },
    { { "!danger", "?haunted", "?castle", "?", NULL },
      25,
      AR_CASTLE,
      28,
      "There are ghosts in the Haunted Castle. They'll curse you! It takes a Corporal to survive that.",
      0 },
    { { "!tell", "?haunted", "?castle", "?", NULL },
      25,
      AR_CASTLE,
      28,
      "There are ghosts in the Haunted Castle. They'll curse you! It takes a Corporal to survive that.",
      0 },
    { { "!who", "!in", "?haunted", "?castle", "?", NULL },
      25,
      AR_CASTLE,
      28,
      "There are ghosts in the Haunted Castle. They'll curse you! It takes a Corporal to survive that.",
    ...
    { { "!danger", "?cursed", "?tomb", "?", NULL },
      25,
      AR_TOMB,
      50,
      "The Cursed Tomb is inhibitated by skeletons. They're poor fighters, but you need strong armor to survive their magic.",
      0 },
    { { "!tell", "?cursed", "?tomb", "?", NULL },
      25,
      AR_TOMB,
      50,
      "The Cursed Tomb is inhibitated by skeletons. They're poor fighters, but you need strong armor to survive their magic.",
      0 },
    { { "!who", "!in", "?cursed", "?tomb", "?", NULL },
      25,
      AR_TOMB,
      50,
      "The Cursed Tomb is inhibitated by skeletons. They're poor fighters, but you need strong armor to survive their magic.",
    ...
    { { "!danger", "?joe", "?house", "?", NULL },
      25,
      AR_JOE,
      64,
      "It might be wise to assure that Joe will not get any help when you attack him.",
      0 },
    { { "!tell", "?joe", "?house", "?", NULL },
      25,
      AR_JOE,
    ...
    { { "!why", "?want", "?bronze",
      ...
      AR_JOE,
      64,
      "The bronze armor was a gift from my father. Joe stole it.",
      0 },
    { { "!what", "?bronze",
        "!armor"
        "?",
    ...
    { { "?black", "!stronghold", "!coin", "?", NULL },
      25,
      AR_STRONGHOLD,
      72,
      "Bring me one of the black candles from the Stronghold, and I'll give you the star part of the coin.",
      0 },

    { { "!help", "?need", "?stronghold", "?", NULL },
      0,
      AR_STRONGHOLD,
      518,
      "Every few hours a horde of monsters from the Black Stronghold is attacking our outpost or the city entrance. If you could help "
      "PROTECT these places, or - even better - enter the STRONGHOLD and stop the monsters, we'd reward you.",
      0 },
    { { "!protect", "?outpost", "?city", "?entrance", "?", NULL },
      0,
      AR_STRONGHOLD,
      518,
      "Wait close to one of these points till the guards there shout alert. Then help them in the fight. They'll report your success and "
      "you can collect your REWARD here afterwards.",
      0 },
    { { "!reward", "?protect", "?city", "?stronghold", "?", NULL },
      0,
      AR_STRONGHOLD,
      518,
      "Depending on your success you will get money, potions or experience. Ask about your POINTS...",
      0 },
    { { "!stronghold", "?enter", "?attack", "?black", "?", NULL },
      0,
      AR_STRONGHOLD,
      518,
      "The monsters are coming from the Black Stronghold. Some evil magic is creating them. As far as we know, this magic needs black "
      "candles. So if you can bring us some black candles we will know you were successful and REWARD you.",
      0 },
    { { "!points", "?", NULL },
      0,
      AR_STRONGHOLD,
      518,
      "You have %d points. You can BUY GOLD at one coin per point, BUY HEALING potions for 6 points, BUY MANA potions for 9 points or BUY "
      "EXPerience at %d exp per point.",
      POINTS },
    ...
    { { "!danger", "!mine", "?", NULL },
      ...
      AR_MINE,
      0,
      "Mining can be dangerous. Place supporting beams to prevent it from collapsing. And don't go into the lower levels too early.",
      0 },
    { { "!tell", "!mine", "?", NULL },
      0,
      AR_MINE,
      0,
      "The mine was opened only a few years ago. At first, it was a very profitable business. But the workers fled when some of them were "
      "killed by skeletons.",
      0 },
    ...
    { { "!where", "?skeleton", "!lord", "?", NULL },
      ...
      "The Skeleton Lord is in the dark, large building in the middle of Merchants Way.",
      0 },
    { { "!where", "!potion", "?skeleton", "?lord", "?", NULL },
      50,
      AR_SLORD,
      90,
      "The potion the Skeleton Lord has could be in a hidden area.",
      0 },
    { { "!danger", "?skeleton", "?lord", "?", NULL },
      50,
      AR_SLORD,
      90,
      "The Skeleton Lord still has some guards who will protect him. A bold Sergeant should be able to kill them.",
      0 },
    { { "!tell", "?skeleton", "?lord", "?", NULL },
      50,
      AR_SLORD,
      90,
      "The Skeleton Lord still has some guards who will protect him. A bold Sergeant should be able to kill them.",
      0 },
    { { "!who", "!in", "?skeleton", "?lord", "?", NULL },
      50,
      AR_SLORD,
      90,
      "The Skeleton Lord still has some guards who will protect him. A bold Sergeant should be able to kill them.",
      0 },
    { { "!why", "?want", "!potion", "?", NULL },
      25,
      AR_SLORD,
      90,
      "I created the potion when the lord was still alive. Now that he turned into a skeleton, he has no more need for it.",
      0 },
    { { "!what", "!potion", "?", NULL },
      25,
      AR_SLORD,
      90,
      "It's a greater healing potion. I created the potion when the lord was still alive.",
      0 },
    { { "!tell", "!potion", "?", NULL },
      25,
      AR_SLORD,
    ...
    { { "!where", "?templar", "!outlaw", "?", NULL },
      ...
      "The Templar Outlaws live in a fortified building in the south-west corner of Aston.",
      0 },
    { { "!danger", "?templar", "?outlaw", "?", NULL },
      0,
      AR_OUTLAW,
      91,
      "The Templar Outlaws are very skilled fighters, and there are many of them. A Staff Sergeant could try to attack them.",
      0 },
    { { "!tell", "?templar", "?outlaw", "?", NULL },
      0,
      AR_OUTLAW,
      91,
      "The Templar Outlaws are very skilled fighters, and there are many of them. A Staff Sergeant could try to attack them.",
      0 },
    { { "!why", "?want", "?barbarian", "!sword", "?", NULL },
      0,
      AR_OUTLAW,
      91,
      "It's a good weapon. I like it. And the templars are outlaws, taking from them is not stealing...",
      0 },
    { { "!what", "?barbarian", "!sword", "?", NULL },
      0,
      AR_OUTLAW,
      91,
      "The barbarian sword is an old weapon. It was made by an now extinct race of barbarians.",
      0 },
    { { "!tell", "?barbarian", "!sword", "?", NULL },
      0,
      AR_OUTLAW,
      91,
      "The barbarian sword is an old weapon. It was made by an now extinct race of barbarians.",
    ...
    { { "?second", "!door", "?thief", "?house", "?", NULL },
      ...
      AR_THIEF2,
      107,
      "The second locked door in the Thieves House? You might have to pick the lock.",
      0 },
    { { "!danger", "?thief", "?house", "?", NULL },
      25,
      AR_THIEF2,
      107,
      "Be careful behind the second locked door in the Thieves House. The thieves there know how to fight.",
      0 },
    { { "!tell", "?thief", "?house", "?", NULL },
      25,
      AR_THIEF2,
    ...
    { { "!who", "?thief", "?house", "?", NULL },
      ...
      "Be careful behind the second locked door in the Thieves House. The thieves there know how to fight.",
      0 },
    { { "!why", "?want", "?ruby", "!amulet", "?", NULL },
      25,
      AR_THIEF2,
      107,
      "The Ruby Amulet belongs to me. A few days after I showed it to Jamil it vanished. I'm sure the thieves took it.",
      0 },
    { { "!what", "?ruby", "!amulet", "?", NULL },
      25,
      AR_THIEF2,
      107,
      "It's a small golden amulet with a big ruby on it. It increases your ability to cast magic spells.",
      0 },
    { { "!tell", "?ruby", "!amulet", "?", NULL },
      25,
      AR_THIEF2,
      107,
      "It's a small golden amulet with a big ruby on it. It increases your ability to cast magic spells.",
    ...
    { { "!danger", "?magic", "?maze", "?", NULL },
      50,
      AR_MMAZE,
      108,
      "The Magic Maze is full of traps. Be careful and look for all clues you can get. There's also a powerful sorceress you will have to "
      "fight.",
      0 },
    { { "!tell", "?magic", "?maze", "?", NULL },
      50,
      AR_MMAZE,
      108,
      "The Magic Maze is full of traps. Be careful and look for all clues you can get. There's also a powerful sorceress you will have to "
    ...
    { { "!tell", "sorceress", "?", NULL },
      ...
      AR_MMAZE,
      108,
      "The sorceress is called Jane. I don't know much about her, only that she killed a few people who survived her maze.",
      0 },
    { { "!why", "?want", "!potion", "?", NULL },
      25,
      AR_MMAZE,
      108,
      "It's a very strong mana potion and I need it to complete a certain magic spell I've been studying for several years now.",
      0 },
    ...
    { { "!where", "?stone", "!sword", "?", NULL },
      0,
      AR_GENERAL,
      109,
      "Now where was that damn stone? Let me think. Ah! I remember. It's over there, in that corner.",
      0 },
    { { "!where", "!stone", "?sword", "?", NULL },
      0,
      AR_GENERAL,
    ...
    { { "?too", "?weak", NULL },
      ...
      AR_GENERAL,
      109,
      "If you're not strong enough to take the sword now, you might need some form of enchantment. Why not go to Damor's Shop and see if "
      "he can help?",
      0 },
    { { "?not", "?strong", "?enough", NULL },
      0,
      AR_GENERAL,
      109,
      "If you're not strong enough to take the sword now, you might need some form of enchantment. Why not go to Damor's Shop and see if "
    ...
    { { "?how", "!get", "!sword", NULL },
      ...
      "he can help?",
      0 },
    { { "!why", "?want", "?stone", "!sword", "?", NULL },
      0,
      AR_GENERAL,
      109,
      "I've been staring at this stone for years. Can't you imagine I want the matter settled so I can throw the damn stone away?",
      0 },
    ...
    { { "!how", "?create", "?mix", "?potion", "?life", "?", NULL },
      0,
      AR_GENERAL,
      111,
      "If I knew how to mix the Potion of Life, I'd do it myself. All I can tell you is that you need three rare flowers.",
      0 },
    { { "!what", "!ingredients", "?potion", "?life", "?", NULL },
      0,
      AR_GENERAL,
      111,
      "All I can tell you is that you need three rare flowers to mix the Potion of Life.",
      0 },
    { { "!why", "?want", "!potion", "?life", "?", NULL }, 0, AR_GENERAL, 111, "I'm sick. The Potion of Life would cure me.", 0 },
    { { "!where", "!potion", "?life", "?", NULL },
      0,
      AR_GENERAL,
      111,
      "I don't think you can find the Potion of life somewhere. You'll have to create it.",
      0 },

    { { "!how", "?first", "?door", "?grolm", "?", NULL },
      50,
      AR_GROLM,
      114,
      "You need a key to get through the first door in the Grolm Gorge.",
      0 },
    { { "!how", "!second", "?door", "?grolm", "?", NULL },
      75,
      AR_GROLM,
      114,
      "You need a crown to get through the second door in the Grolm Gorge.",
      0 },
    { { "!how", "!third", "?door", "?grolm", "?", NULL },
      75,
      AR_GROLM,
      114,
      "You need a trident to get through the third door in the Grolm Gorge.",
      0 },
    { { "!what", "!second", "?door", "?grolm", "?", NULL },
      75,
      AR_GROLM,
      114,
      "You need a crown to get through the second door in the Grolm Gorge.",
      0 },
    { { "!what", "!third", "?door", "?grolm", "?", NULL },
      75,
      AR_GROLM,
      114,
      "You need a trident to get through the third door in the Grolm Gorge.",
      0 },
    { { "!where", "!key", "?grolm", "?", NULL },
      100,
      AR_GROLM,
      114,
      "The key for the first door in the Grolm Gorge is in a very hot place.",
      0 },
    { { "!where", "!crown", "?grolm", "?", NULL }, 100, AR_GROLM, 114, "The crown from the Grolm Gorge? I'd expect the king wears it.", 0 },
    { { "!where", "!trident", "?grolm", "?", NULL },
      100,
      AR_GROLM,
      114,
      "The trident from the Grolm Gorge? The Grolm Mages are said to use tridents.",
      0 },
    { { "!what", "!key", "?grolm", "?", NULL }, 100, AR_GROLM, 114, "The key is used to open the first door.", 0 },
    { { "!what", "!crown", "?grolm", "?", NULL },
      100,
      AR_GROLM,
      114,
      "The crown from the Grolm Gorge? It's used to open the second door.",
      0 },
    { { "!what", "!trident", "?grolm", "?", NULL },
      100,
      AR_GROLM,
      114,
      "The trident from the Grolm Gorge? It's used to open the third door.",
      0 },

    { { "!how", "?first", "?door", "?lizard", "?", NULL },
      50,
      AR_LIZARD,
      162,
      "You need a key to get through the first door in the Lizard Gorge.",
      0 },
    { { "!how", "!second", "?door", "?lizard", "?", NULL },
      75,
      AR_LIZARD,
      162,
      "You need a key to get through the second door in the Lizard Gorge.",
      0 },
    { { "!how", "!third", "?door", "?lizard", "?", NULL },
      75,
      AR_LIZARD,
      162,
      "You need a key to get through the third door in the Lizard Gorge.",
      0 },
    { { "!where", "!key", "?lizard", "?", NULL },
      100,
      AR_LIZARD,
      162,
      "The Merchants here will give you the keys for special items. Go to them to learn which items you need.",
      0 },
    { { "!where", "!coconut", "?lizard", "?", NULL }, 100, AR_LIZARD, 162, "The coconut? Well, coconuts grow in trees, you know?", 0 },
    { { "!where", "!potion", "?agility", "?", NULL },
      100,
      AR_LIZARD,
      162,
      "You have to mix the Potion of Superior Agility from some flower which grow here.",
      0 },
    { { "!where", "!teeth", "?lizard", "?", NULL }, 100, AR_LIZARD, 162, "Lizard's Teeth? I'd assume they have them in their mouths.", 0 },
    { { "!how", "?teeth", "!necklace", "?", NULL },
      100,
      AR_LIZARD,
      162,
      "To create the Lizard's Teeth Necklace, you need a leather string and teeth. One of the Merchants sells leather strings.",
      0 },
    ...
    { { "?ratling", "!eye", "?", NULL },
      ...
      AR_UNDER_I,
      246,
      "Yes. I need them to create a very powerful stimulant. If you want to help me, buy a collector in Damor's shop and bring me a full "
      "set of Ratling's Eyes.",
      0 },
    { { "!ratling", "?", NULL },
      100,
      AR_UNDER_I,
      246,
      "The Ratlings live below the city, in the Underground. They look like humans, except for the head, which resembles that of a rat. Be "
      "careful, some of the are very strong, and all of them can see in the dark.",
      0 },
    { { "!stimulant", "?", NULL },
      100,
      AR_UNDER_I,
      246,
      "The stimulant will be extremely powerful. I'll be able to create two potions of it. You'll get one of them as payment.",
      0 },
    { { "!potion", "?", NULL },
      100,
      AR_UNDER_I,
      246,
      "The potion will be extremely powerful stimulant. I'll be able to create two potions of it. You'll get one of them as payment.",
      0 },
    { { "!payment", "?", NULL },
      100,
      AR_UNDER_I,
      246,
      "I can create two potions from a complete set of eyes. I'll give you one of them as payment.",
      0 },
    ...
    { { "!underground", "?", NULL },
      ...
      AR_UNDER_I,
      246,
      "The City Guards have recently discovered some holes in the ground of several buildings. They lead into a maze of rooms and "
      "corridors. It seems the thieves are using them too.",
      0 },
    { { "!thief", "?", NULL },
      100,
      AR_UNDER_I,
      246,
      "A thief was trying to sell information about Azraels Helmet. A City Guard was chasing him, but he vanished in the Thief House. "
      "Later searches showed he used a hidden hole in the floor to escape.",
      0 },
    { { "!azrael", "?helm", "?", NULL },
      100,
      AR_UNDER_I,
      246,
      "Lord Azrael of Aston once ruled this city. But he vanished during a fight in his castle. He possesed a powerful helmet, the Helm of "
      "Shadows.",
      0 },
    { { "!castle", "?", NULL },
      100,
      AR_UNDER_I,
      246,
      "It is now the Haunted Castle. After Azrael vanished, it was abandoned. Now it's inhabitated by ghosts, and some say they hear "
      "Azraels cry in there.",
      0 },
    { { "!helm", "?shadow", "?", NULL },
      100,
      AR_UNDER_I,
      246,
      "Lord Azrael's famous helmet, the Helm of Shadows. It's enhanced with powerful magic.",
      0 },
    ...
    { { "?ratling", "!eye", "?", NULL },
      ...
      AR_UNDER_I,
      343,
      "Yes. I need it to complete my collection. Robin wants a full set and he promised be a powerful potion in exchange.",
      0 },
    { { "!ratling", "?", NULL },
      100,
      AR_UNDER_I,
    ...
    { { "?what", "!enchant", "!weapon", "?", NULL },
      0,
      AR_GENERAL,
      0,
      "Enchant Weapon is a magic spell. It will make your weapon stronger when you use it.",
      0 },
    { { "?what", "!recall", "?", NULL },
      0,
      AR_GENERAL,
      0,
      "Recall is a magic spell. It will teleport you back to the Temple of Skua when you use it. But beware, there is a small delay "
      "between casting and teleport.",
      0 },
    ...
    { { "?what", "!stun", "?", NULL },
      ...
      AR_GENERAL,
      0,
      "Stun is a magic spell. If you can overcome your target's Resistance, he'll be unable to move for a few seconds.",
      0 },
    ...
    { { "?what", "!identify", "?", NULL },
      ...
      AR_GENERAL,
      0,
      "Identify is a magic spell. It'll give you some information about an item or person.",
      0 },
    { { "?what", "!resistance", "?", NULL },
      0,
      AR_GENERAL,
      0,
      "Resistance is used against magic spells. If you're good at it, it's much harder to Curse or Stun you.",
      0 },
    ...
    { { "?what", "!guardian", "!angel", "?", NULL },
      0,
      AR_GENERAL,
      0,
      "The spell Guardian Angel will lessen the effects of death on you. You can buy it from Damor, in Aston.",
      0 },
    ...
    { { "?what", "!labyrinth", "?", NULL },
      ...
      AR_GENERAL,
      0,
      "The Labyrinth. It's a huge maze full of dangers. If you survive it, you'll become a Seyan'Du.",
      0 },
    { { "?what", "!seyandu", "?", NULL },
      0,
      AR_GENERAL,
      0,
      "The Seyan'Du are very powerful. They do not have the limitations other people have.",
      0 },
    { { "?what", "!limitation", "?", NULL },
      0,
      AR_GENERAL,
      0,
      "The Harakim are powerful sorcerers, the Templars strong fighters and the Mercenaries have a bit of both. But the Seyan'Du combine "
      "their abilities.",
      0 },
    { { "?what", "!templar", "?", NULL },
      0,
      AR_GENERAL,
      0,
      "The Templars are powerful fighters. But they're not very good with magic.",
      0 },
    ...
    { { "!who", "!skua", "?", NULL },
      ...
      AR_GENERAL,
      0,
      "Skua is the god of justice and order. He fights a perpetual battle against the Purple One.",
      0 },
    { { "!who", "!purple", "!one", "?", NULL }, 0, AR_GENERAL, 0, "The Purple One? He's the god of chaos and disorder.", 0 },

    { { "?what", "!order", "?purple", "?one", "?", NULL },
      10,
      AR_PURPLE,
      180,
      "Our order, the Cult of the Purple One, does not believes in rules. Join us, and you can do whatever you want.",
      0 },
    { { "?tell", "!order", "?purple", "?one", "?", NULL },
      10,
      AR_PURPLE,
      180,
      "Our order, the Cult of the Purple One, does not believes in rules. Join us, and you can do whatever you want.",
      0 },
    { { "?how", "!join", "?order", "?purple", "?one", "?", NULL },
      10,
      AR_PURPLE,
      180,
      "If you join us, you will be able to kill your fellow players. But beware! Others can kill you as well, and this decision is "
      "irrevocable! Do you want to join?",
      0 },
    { { "?what", "!happens", "!join", "?order", "?purple", "?one", "?", NULL },
      10,
      AR_PURPLE,
      180,
      "If you join us, you will be able to kill your fellow players. But beware! Others can kill you as well, and this decision is "
    ...
    { { "!poem", "?first", "?", NULL },
      ...
      AR_KNIGHT,
      317,
      "Where the sun rises in a clouded sky     A mere touch will reveal where hidden lie       A skull which, when enlighted, will give "
      "thee    A brave enemy and a precious key.",
      0 },
    { { "!poem", "?second", "?", NULL },
      10,
      AR_KNIGHT,
      317,
      "A dark sky, a large tree                 Weavers work in crimson                         The corner of which guides thee            "
      "      To key's holder, the lord's son.",
      0 },
    { { "!second", "?", NULL },
      10,
      AR_KNIGHT,
    ...
    { { "?ice", "!egg", NULL },
      ...
      AR_NEST,
      615,
      "I heard that the ice gargoyles guard an ice egg in their nest. I'd be most grateful if you could bring it to me. But hurry, before "
      "it melts!",
      0 },
    { { "?ice", "!cloak", NULL },
      0,
      AR_NEST,
      615,
      "The Ice Cloak is a fine piece of armor, but it melts in due time. I can give you one if you obtain an ice egg for me.",
      0 },
...
void answer_spellinfo( int cn, int co )
{
  ...
  if ( obey( cn, co ) == 1 )
  {
    for ( n = 0; n < 20; n++ )
    {
      if ( ( in = ch[ cn ].spell[ n ] ) )
      {
        do_sayx( cn, "%s, for %dm %ds.", it[ in ].name, it[ in ].active / ( 18 * 60 ), ( it[ in ].active / 18 ) % 60 );
        found = 1;
      }
    }
    if ( ! found )
...
void answer_time( int cn, int co )
{
  do_sayx( cn, "Today is the %d%s%s%s%s day of the Year %d. It is %d:%02d Astonian Standard Time.\n", globs->mdday,
           ( globs->mdday == 1 ? "st" : "" ), ( globs->mdday == 2 ? "nd" : "" ), ( globs->mdday == 3 ? "rd" : "" ),
           ( globs->mdday > 3 ? "th" : "" ), globs->mdyear, globs->mdtime / 3600, ( globs->mdtime / 60 ) % 60 );
}
...
void npc_hear( int cn, int co, char* text )
{
  ...
  if ( talk > 0 )
  { // only talk if we're talkative or addressed directly
    if ( bestconf > 0 )
    {
