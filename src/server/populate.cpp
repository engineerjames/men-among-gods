...
int pop_create_bonus( int cn, int chance )
{
  ...
  {
    static int gitem[] = { 273, 274, 693, 273, 274, 694, 273, 274, 695, 273, 274, 696, 273, 274, 697, 273,
                           274, 698, 361, 360, 487, 361, 360, 488, 361, 360, 489, 337, 361, 292, 525, 526 };
  ...
  {
    static int gitem[] = { 273, 274, 699, 273, 274, 700, 273, 274, 701, 273, 274, 702, 273, 274, 703, 273,
                           274, 704, 361, 360, 347, 361, 360, 344, 361, 360, 341, 337, 283, 287, 291 };
    static int item[]  = { 273, 274 };
  ...
  {
    static int gitem[] = { 101, 102, 705, 101, 102, 706, 101, 102, 707, 101, 102, 708, 101, 102, 709,
                           101, 102, 710, 360, 338, 361, 340, 361, 343, 361, 346, 282, 286, 290 };
  ...
  {
    static int gitem[] = { 18, 46, 711, 18,  46,  712, 18,  46,  713, 18,  46,  714, 18,  46, 715,
                           18, 46, 716, 360, 338, 361, 339, 361, 342, 361, 345, 281, 285, 289 };
...
int pop_create_bonus_belt( int cn )
{
  ...
  for ( i = 0; i < j; i++ )
  {
    ...
    case 0:
      ...
      it[ n ].attrib[ AT_BRAVE ][ 2 ] = 10 + ( it[ n ].attrib[ AT_BRAVE ][ 0 ] * RANDOM( 7 ) );
      break;
    case 1:
      it[ n ].attrib[ AT_WILL ][ 0 ] += skill_value;
      if ( it[ n ].attrib[ AT_WILL ][ 0 ] > 12 )
        it[ n ].attrib[ AT_WILL ][ 0 ] = 12;
      it[ n ].attrib[ AT_WILL ][ 2 ] = 10 + ( it[ n ].attrib[ AT_WILL ][ 0 ] * RANDOM( 7 ) );
      break;
    case 2:
    ...
    case 3:
      ...
      it[ n ].attrib[ AT_AGIL ][ 2 ] = 10 + ( it[ n ].attrib[ AT_AGIL ][ 0 ] * RANDOM( 7 ) );
      break;
    case 4:
      it[ n ].attrib[ AT_STREN ][ 0 ] += skill_value;
      if ( it[ n ].attrib[ AT_STREN ][ 0 ] > 12 )
        it[ n ].attrib[ AT_STREN ][ 0 ] = 12;
      it[ n ].attrib[ AT_STREN ][ 2 ] = 10 + ( it[ n ].attrib[ AT_STREN ][ 0 ] * RANDOM( 7 ) );
      break;
    case 5:
    ...
    case 6:
      ...
      if ( it[ n ].end[ 0 ] > 60 )
        it[ n ].end[ 0 ] = 60;
      it[ n ].end[ 2 ] = 50 + ( it[ n ].end[ 0 ] * RANDOM( 7 ) );
      break;
    case 7:
    ...
    case 10:
      ...
      it[ n ].skill[ SK_HAND ][ 2 ] = ( it[ n ].skill[ SK_HAND ][ 0 ] * RANDOM( 7 ) );
      break;
    case 11:
    ...
    case 14:
      ...
      it[ n ].skill[ SK_LOCK ][ 2 ] = ( it[ n ].skill[ SK_LOCK ][ 0 ] * RANDOM( 7 ) );
      break;
    case 15:
    ...
    case 16:
      ...
      it[ n ].skill[ SK_PERCEPT ][ 2 ] = ( it[ n ].skill[ SK_PERCEPT ][ 0 ] * RANDOM( 7 ) );
      break;
    case 17:
    ...
    case 31:
      ...
      it[ n ].skill[ SK_HEAL ][ 2 ] = ( it[ n ].skill[ SK_HEAL ][ 0 ] * RANDOM( 7 ) );
      break;
    case 32:
    ...
    case 34:
      ...
      it[ n ].skill[ SK_REST ][ 2 ] = ( it[ n ].skill[ SK_REST ][ 0 ] * RANDOM( 7 ) );
      break;
    case 35:
    ...
    case 36:
      ...
      it[ n ].skill[ SK_SENSE ][ 2 ] = ( it[ n ].skill[ SK_SENSE ][ 0 ] * RANDOM( 7 ) );
      break;
    case 37:
...
void pop_tick( void )
{
  ...
  if ( globs->ticker - last_reset >= RESETTICKER )
  { // reset one character per minute
...
void pop_save_char( int nr )
{
  ...
  if ( ch[ nr ].used == USE_EMPTY || ! ( ch[ nr ].flags & ( CF_PLAYER ) ) || ( ch[ nr ].flags & CF_BODY ) ||
