...
int load( void )
{
  ...
  /** MAP **/
  xlog( "Loading MAP: Item size=%d, file size=%dK", sizeof( struct map ), MAPSIZE >> 10 );
  ...
  /** CHAR **/
  xlog( "Loading CHAR: Item size=%d, file size=%dK", sizeof( struct character ), CHARSIZE >> 10 );
  ...
  /** TCHAR **/
  xlog( "Loading TCHAR: Item size=%d, file size=%dK", sizeof( struct character ), TCHARSIZE >> 10 );
  ...
  /** ITEM **/
  xlog( "Loading ITEM: Item size=%d, file size=%dK", sizeof( struct item ), ITEMSIZE >> 10 );
  ...
  /** TITEM **/
  xlog( "Loading TITEM: Item size=%d, file size=%dK", sizeof( struct item ), TITEMSIZE >> 10 );
  ...
  /** EFFECT **/
  xlog( "Loading EFFECT: Item size=%d, file size=%dK", sizeof( struct effect ), EFFECTSIZE >> 10 );
  ...
  /** GLOBS **/
  xlog( "Loading GLOBS: Item size=%d, file size=%db", sizeof( struct global ), sizeof( struct global ) );
